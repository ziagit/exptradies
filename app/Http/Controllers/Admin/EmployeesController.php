...
class EmployeesController extends Controller
{
    ...
    {
        $emps = Employee::with('user')->orderBy('id','DESC')->paginate(10);
    ...
    {
        $emp = Employee::with('user','address','reviews','galeries','services','businessAddresses')->find($id);
    ...
    public function search(Request $request){
        ...
        $emp = Employee::where('first_name', 'like', '%' . $keywords . '%')
