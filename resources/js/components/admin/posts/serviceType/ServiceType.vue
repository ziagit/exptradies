<template>
  <div class="">
    <b-modal id="modal-update" title="Update type" :hide-footer="true" hide-header-close>
      <Edit v-on:close-dialog="refresh" :option="option" />
    </b-modal>
    <!-- add dialog -->
    <b-modal id="modal-add" size="md" title="Add new type" :hide-footer="true" hide-header-close>
      <Add v-on:close-dialog="refresh" />
    </b-modal>
    <b-card v-if="options" header="Type" class="  shadow-none mt-5 mb-5">
